"""Model for the FirewallNatOutboundMode capability endpoint.
...
class FirewallNatOutboundMode(BaseModel):
    mode: str

    @classmethod
    def from_api(cls, data: dict[str, Any]) -> "FirewallNatOutboundMode":
        return cls(
            mode=data["mode"],
        )
