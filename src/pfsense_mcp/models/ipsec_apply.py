"""Model for the IPsecApply capability endpoint.

Field types were derived from the pinned v2.10 OpenAPI schema's
`IPsecApply` component (already-captured evidence, not a new live
...
class IPsecApply(BaseModel):
    applied: bool | None

    @classmethod
    def from_api(cls, data: dict[str, Any]) -> "IPsecApply":
