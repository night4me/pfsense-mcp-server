"""Model for the DNSResolverApply capability endpoint.

Field types were derived from the pinned v2.10 OpenAPI schema's
`DNSResolverApply` component (already-captured evidence, not a new live
...
class DNSResolverApply(BaseModel):
    applied: bool | None

    @classmethod
    def from_api(cls, data: dict[str, Any]) -> "DNSResolverApply":
