...
def test_current_release_state_documentation_is_consistent():
    """v0.4.1's README status paragraph now declares it the immutable
    ...
    v0.4.1 (see the prior commit's version of this docstring for why the
    single `False` was correct at that earlier checkpoint)."""
