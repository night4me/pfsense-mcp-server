...
def test_current_release_state_documentation_is_consistent():
    """v0.5.1's README status paragraph now declares it the immutable
    ...
    v0.5.1 (see the prior commit's version of this docstring for why the
    dict keyed on v0.5.0 was correct at that earlier checkpoint)."""

    assert release_checks(ROOT) == {
        "docs/ACCEPTANCE_v0.5.1.md": True,
