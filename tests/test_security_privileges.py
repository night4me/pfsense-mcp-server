...
is a real, trimmed subset (95 paths -- the current 94 READ + 1 WRITE
...
def test_write_protected_profile_resolves_to_the_currently_verified_95_privileges(live_schema):
