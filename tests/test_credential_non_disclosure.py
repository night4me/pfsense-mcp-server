...
def test_all_read_tools_have_exact_annotations_without_schema_side_effects():
    ...
    # 103 total = 101 pfSense READ tools + 2 guidance tools (pfsense_get_official_guidance,
    # owner-authorized 2026-08-22, and pfsense_get_api_guidance, added
    # 2026-08-28) -- this test is specifically about the 101 READ tools'
...
def test_auth_keys_tool_input_no_longer_has_disclosure_argument():
    ...
    assert len(tools) == 122  # 120 pfSense READ tools + 2 guidance tools
