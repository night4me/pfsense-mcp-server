"""Live integration test for get_firewall_nat_outbound_mode. GENERATED PROPOSAL — review before use.
...
from pfsense_mcp.models.firewall_nat_outbound_mode import FirewallNatOutboundMode
...
def test_get_firewall_nat_outbound_mode_live_structure_only():
    config = load_config()
    ...
    try:
        ...
        assert isinstance(result, FirewallNatOutboundMode)
    finally:
        transport.close()
