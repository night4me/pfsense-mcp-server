"""Live integration test for get_system_version. GENERATED PROPOSAL — review before use.
...
from pfsense_mcp.models.system_version import SystemVersion
...
def test_get_system_version_live_structure_only():
    config = load_config()
