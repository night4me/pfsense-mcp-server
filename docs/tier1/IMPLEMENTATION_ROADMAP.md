...
| 4. Disposable-lab validation | Phase 3 | ADR-016 accepted (2026-08-08); separate live-run approval still required | Harness implementation unblocked, not started |
