...
- Approve a protected-artifact encryption/key-provider design; HMAC integrity
  alone is not confidentiality.
- Approve the persistent-store location, retention, backup/anti-rollback anchor,
  and operator reconciliation authority.
...
- Approve the capability, endpoint/method allow-list entry, tool schema,
  production construction, and live acceptance as separate gates.
