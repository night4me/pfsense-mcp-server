...
| [024](ADR-024-execution-authorization-coordination.md) | Execution-authorization coordination boundary (`ADR-022` Phase E/F/G territory) | Proposed (architecture) — Slice E1 (freshness primitive) separately authorized and implemented; coordinator and remaining slices still unauthorized, unimplemented |
